...
final class SelfTestUIDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let controller = SettingsWindowController(store: store, gridStore: GridTilingSettingsStore())
    ...
    private func testPerAppMarginDrawer() {
        ...
        let newController = SettingsWindowController(store: store, gridStore: GridTilingSettingsStore())
